Webruntime.define('lwc/publicMethodParent', ['lwc', 'lightning/configProvider', 'c/publicMethodChild'], function (lwc, configProvider, _cPublicMethodChild) { 'use strict';

    _cPublicMethodChild = _cPublicMethodChild && Object.prototype.hasOwnProperty.call(_cPublicMethodChild, 'default') ? _cPublicMethodChild['default'] : _cPublicMethodChild;
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.onInputChange))
        }
        ...
        key: 1,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.checkboxSelectHandler))
        }
      }, []), api_custom_element("c-public-method-child", _cPublicMethodChild, {
        key: 2
      }, [])])];
    }
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-publicMethodParent_publicMethodParent-host",
      shadowAttribute: "lwc-publicMethodParent_publicMethodParent"
    };

    class PublicMethodParent extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.value = void 0;
      }
    ...
    lwc.registerDecorators(PublicMethodParent, {
      track: {
        value: 1
      }
    });

    var publicMethodParent = lwc.registerComponent(PublicMethodParent, {
      tmpl: _tmpl$m
    });

    return publicMethodParent;
