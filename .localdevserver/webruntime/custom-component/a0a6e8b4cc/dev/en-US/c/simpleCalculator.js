Webruntime.define('lwc/simpleCalculator', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$r($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handleNumberChange))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "padding": "around-medium",
        ...
        key: 2,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.handleNumberChange))
        }
      }, [])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "padding": "around-medium",
        ...
        key: 5,
        on: {
          "click": _m3 || ($ctx._m3 = api_bind($cmp.handleSubtract))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Multiply",
        ...
        key: 6,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.handleMultiply))
        }
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Divide",
        ...
        key: 7,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.handleDivide))
        }
      }, [])])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        ...
        key: 12,
        on: {
          "change": _m6 || ($ctx._m6 = api_bind($cmp.handleShowPreviousResults))
        }
      }, [])]), $cmp.showPreviousResults ? api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        },
        key: 19
        ...
        key: 18
      }, api_iterator($cmp.previousResults, function (resultValue, resultIndex, resultFirst, resultLast) {
        return api_element("li", {
          key: api_key(17, resultValue)
        }, [resultFirst ? api_element("div", {
          classMap: {
            "slds-border_top": true
          },
          key: 14
        }, []) : null, api_custom_element("lightning-formatted-text", _lightningFormattedText, {
          props: {
            "value": resultValue
          },
          key: 15
        }, []), resultLast ? api_element("div", {
          classMap: {
    ...
    tmpl$r.stylesheetTokens = {
      hostAttribute: "lwc-simpleCalculator_simpleCalculator-host",
      shadowAttribute: "lwc-simpleCalculator_simpleCalculator"
    };

    class SimpleCalculator extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.currentResult = "Try it out";
        this.previousResults = [];
        this.showPreviousResults = false;
        this.firstNumber = void 0;
        this.secondNumber = void 0;
      }
      ...
      handleAdd() {
        ...
        this.currentResult = `Result of ${this.firstNumber} + ${this.secondNumber} is ${first + second}`;
      }
    ...
    lwc.registerDecorators(SimpleCalculator, {
      track: {
        currentResult: 1,
        previousResults: 1,
        showPreviousResults: 1
      },
      fields: ["firstNumber", "secondNumber"]
    });

    var simpleCalculator = lwc.registerComponent(SimpleCalculator, {
      tmpl: _tmpl$q
    });
