Webruntime.define('lwc/meetinRooms', ['lwc', 'lightning/configProvider', 'c/meetingRoom'], function (lwc, configProvider, _cMeetingRoom) { 'use strict';
    ...
    **/
    ...
    var mediaTile = lwc.registerTemplate(tmpl$7);
    tmpl$7.slots = ["media", ""];
    tmpl$7.stylesheets = [];
    ...
    var standardTile = lwc.registerTemplate(tmpl$8);
    tmpl$8.slots = [""];
    tmpl$8.stylesheets = [];

    if (_implicitStylesheets$2) {
      tmpl$8.stylesheets.push.apply(tmpl$8.stylesheets, _implicitStylesheets$2);
    }
    ...
    function tmpl$9($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          attrs: {
            "title": room.roomCapacity
          },
          key: 0
        }, [api_text("Room Capacity: "), api_dynamic($cmp.meetingRoomInfo.roomCapacity)])]), api_element("div", {
          key: 2
        }, [api_text("Addtional Markup for unnamed Slot")])])]);
      }))])];
    }
