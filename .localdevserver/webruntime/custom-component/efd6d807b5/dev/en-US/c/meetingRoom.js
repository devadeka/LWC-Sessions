Webruntime.define('lwc/meetingRoom', ['lwc', 'lightning/configProvider', 'c/pubsub', 'lightning/navigation'], function (lwc, configProvider, pubsub, navigation) { 'use strict';
  ...
  **/
  ...
  var mediaTile = lwc.registerTemplate(tmpl$5);
  tmpl$5.slots = ["media", ""];
  tmpl$5.stylesheets = [];
  ...
  var standardTile = lwc.registerTemplate(tmpl$6);
  tmpl$6.slots = [""];
  tmpl$6.stylesheets = [];

  if (_implicitStylesheets$3) {
    tmpl$6.stylesheets.push.apply(tmpl$6.stylesheets, _implicitStylesheets$3);
  }
  ...
  function tmpl$7($api, $cmp, $slotset, $ctx) {
    ...
    return [$cmp.showRoomInfo ? api_element("div", {
      ...
      key: 2,
      on: {
        "click": _m0 || ($ctx._m0 = api_bind($cmp.tileClickHandler))
      }
      ...
      key: 0
    }, [api_text("Room Capacity: "), api_dynamic($cmp.meetingRoomInfo.roomCapacity)])])]) : null];
  }
  ...
  class MeetingRoom extends lwc.LightningElement {
    ...
    tileClickHandler() {
      ...
      pubsub.fireEvent(this.pageRefference, "pubsubTileClick", this.meetingRoomInfo);
