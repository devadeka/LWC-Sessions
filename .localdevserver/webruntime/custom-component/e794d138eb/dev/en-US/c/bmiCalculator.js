Webruntime.define('lwc/bmiCalculator', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.onWeightChange))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "type": "number",
        ...
        key: 1,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.onHeightChange))
        }
        ...
        key: 2,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.calculateBMI))
        }
      }, []), api_element("p", {
        key: 3
      }, [api_dynamic($cmp.bmiValue)])])];
    }

    var _tmpl$m = lwc.registerTemplate(tmpl$n);
    tmpl$n.stylesheets = [];
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-bmiCalculator_bmiCalculator-host",
      shadowAttribute: "lwc-bmiCalculator_bmiCalculator"
    };

    class BmiCalculator extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.bmiTitle = "BMI Calculator";
        this.bmiData = {
          weight: 0,
          height: 0,
          result: 0
    ...
    lwc.registerDecorators(BmiCalculator, {
      track: {
        bmiData: 1
      },
      fields: ["bmiTitle"]
    ...
    var bmiCalculator = lwc.registerComponent(BmiCalculator, {
      tmpl: _tmpl$m
    });
