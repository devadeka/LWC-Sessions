Webruntime.define('lwc/meetinRooms', ['lwc', 'lightning/configProvider', 'c/meetingRoom'], function (lwc, configProvider, _cMeetingRoom) { 'use strict';

    _cMeetingRoom = _cMeetingRoom && Object.prototype.hasOwnProperty.call(_cMeetingRoom, 'default') ? _cMeetingRoom['default'] : _cMeetingRoom;
    ...
    **/
    ...
    function tmpl$5($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 2
      }, api_iterator($cmp.meetinRoomsInfo, function (room) {
        return api_element("li", {
          styleMap: {
            "padding": "10px"
          },
          key: api_key(1, room.roomName)
        }, [api_custom_element("c-meeting-room", _cMeetingRoom, {
          props: {
            "meetingRoomInfo": room,
            "showRoomInfo": true
          },
          key: 0,
          on: {
            "tileclick": _m0 || ($ctx._m0 = api_bind($cmp.onTileSelectHandler))
          }
        }, [])]);
      }))]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
        ...
        key: 4
      }, [api_text("You have selected: "), api_dynamic($cmp.selectedMeetingRoomInfo)])])])];
    }

    var _tmpl$6 = lwc.registerTemplate(tmpl$5);
    tmpl$5.stylesheets = [];
    tmpl$5.stylesheetTokens = {
      hostAttribute: "lwc-meetinRooms_meetinRooms-host",
      shadowAttribute: "lwc-meetinRooms_meetinRooms"
    };

    class MeetinRooms extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.selectedMeetingRoomInfo = void 0;
        this.meetinRoomsInfo = [{
          roomName: "A-01",
          roomCapacity: "12"
        }, {
          roomName: "A-02",
      ...
      onTileSelectHandler(event) {
        ...
        console.log(typeof meetingRoomInfo);
        this.selectedMeetingRoomInfo = meetingRoomInfo.room;
        console.log(this.selectedMeetingRoomInfo);
      }

    }

    lwc.registerDecorators(MeetinRooms, {
      track: {
        selectedMeetingRoomInfo: 1
      },
      fields: ["meetinRoomsInfo"]
    });

    var meetinRooms = lwc.registerComponent(MeetinRooms, {
      tmpl: _tmpl$6
    });
