    ...
    function tmpl$9($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        return api_element("li", {
          ...
          props: {
            "label": $cmp.meetingRoomInfo.roomName,
          ...
          attrs: {
            "title": $cmp.meetingRoomInfo.roomCapacity
          },
          key: 0
        }, [api_text("Room Capacity: "), api_dynamic($cmp.meetingRoomInfo.roomCapacity)])])])]);
      }))])];
    }
